    ...
    <div className="border-border/10 flex w-full flex-col gap-y-2 rounded-lg border bg-white/5">
      <div className="flex flex-col gap-y-4 p-3">
        ...
        <div className="flex flex-col gap-y-2">
          <p className="text-xs">
            {data.agents}/{MAX_FREE_AGENTS} Agents
          </p>
          <Progress value={(data.agents / MAX_FREE_AGENTS) * 100} />
        </div>
        <div className="flex flex-col gap-y-2">
          <p className="text-xs">
            {data.meetings}/{MAX_FREE_MEETINGS} Meetings
          </p>
          <Progress value={(data.meetings / MAX_FREE_MEETINGS) * 100} />
        </div>
        <Button
